"use strict";exports.__esModule=true;exports.default=void 0;var _arg=_interopRequireDefault(require("arg"));var _path=require("path");var _emptyDir=require("empty-dir");var _fs=require("fs");var _chalk=_interopRequireDefault(require("chalk"));var _through=_interopRequireDefault(require("through2"));var _vinylFs=_interopRequireDefault(require("vinyl-fs"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function info(type,message){console.log(`${_chalk.default.green.bold(type)}  ${message}`);}function error(message){console.error(_chalk.default.red(message));}function success(message){console.error(_chalk.default.green(message));}function template(dest,cwd){return _through.default.obj(function(file,enc,cb){if(!file.stat.isFile()){return cb();}info('create',file.path.replace(cwd+'/',''));this.push(file);cb();});}const haInit=argv=>{const args=(0,_arg.default)({// Types
