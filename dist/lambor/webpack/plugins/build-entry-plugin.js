"use strict";exports.__esModule=true;exports.default=void 0;var _webpackSources=require("webpack-sources");var _constants=require("../../lib/constants");class BuildManifestPlugin{apply(compiler){compiler.hooks.emit.tapAsync('lamborEntryFiles',(compilation,callback)=>{const assetMap={default:[]};for(const[urlKey,entrypoint]of compilation.entrypoints.entries()){for(const file of entrypoint.getFiles()){assetMap.default.push({publicPath:`/dist/${file}`});//     if (/\.map$/.test(file) || /\.hot-update\.js$/.test(file)) {
//     continue
//     }
