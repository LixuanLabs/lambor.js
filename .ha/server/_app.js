...
!(__N_SSG||__N_SSP)?{url:createUrl(router)}:{}));}}exports.default=App;let warnContainer;let warnUrl;if(process.env.NODE_ENV!=='production'){warnContainer=()=>{console.warn(`Warning: the \`Container\` in \`_app\` has been deprecated and should be removed. https://err.sh/zeit/next.js/app-container-deprecated`);};warnUrl=()=>{console.error(`Warning: the 'url' property is deprecated. https://err.sh/zeit/next.js/url-deprecated`);};}// @deprecated noop for now until removal
